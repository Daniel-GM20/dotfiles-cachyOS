...
local closeFlags = { locked = true, allow_input_capture = true, dont_inhibit = true }
...
hl.bind(mainMod .. " + Q",           hl.dsp.exec_cmd("/home/ulisesg/.config/hypr/scripts/close-active.sh"), closeFlags)
hl.bind(mainMod .. " + BackSpace",   hl.dsp.exec_cmd("/home/ulisesg/.config/hypr/scripts/close-active.sh"), closeFlags)
hl.bind("ALT + F4",                  hl.dsp.exec_cmd("/home/ulisesg/.config/hypr/scripts/close-active.sh"), closeFlags)
hl.bind(mainMod .. " + SHIFT + Q",   hl.dsp.window.kill(), closeFlags)
...
-- Focus on workspace number (Windows + 1/2/3)
for i = 1, NUM_WPM do
    local key = i % 10
