...
hl.window_rule({ match = { class = "^(steam)$", title = "^(Sign in to Steam|Updating Steam|Steam - News).*$" }, float = true, center = true })
...
-- Blur Noctalia bar, dock, panels, and notifications
hl.layer_rule({
    name = "noctalia",
    match = {
